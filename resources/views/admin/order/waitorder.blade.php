...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Đơn đặt hàng đang chờ xác nhận</h4>
        <div class="table-responsive pt-3">
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                <td>
                    <button type="button" class="btn btn-outline-danger btn-fw" onclick="window.location.href='{{URL::to('/decline-order/'.$row->shipping_id)}}'">X</button>
                    <button type="button" class="btn btn-outline-success btn-fw" onclick="window.location.href='{{URL::to('/accept-order/'.$row->shipping_id)}}'">Xác nhận</button>
                </td>
                <td>
